  ...
  <div class="main">
    ...
    <div class="absolute top-0">
      <div class="lg:ml-32 pl-5">
        ...
        <input
          class="p-3 rounded-lg w-32 my-3 bg-l-blue text-white text-xs"
          type="button"
          value="GET STARTED"
        />
      </div>
      ...
      <div class="lg:flex justify-center text-center">
        <div class="shadow-xl lg:w-1/6	p-4 m-3 py-6 rounded-md">
          ...
          <div>
            ...
            <p class="text-sm">
              We guarantee that your funds are 100% secured. We do no store but
              trade.
            </p>
          </div>
        </div>
        ...
        <div class="shadow-xl lg:w-1/6	p-4 m-3 py-6 rounded-md">
          ...
          <div>
            ...
            <p class="text-sm pb-5">
              Profits are made on daily bases deploying our effective trading
              strategy
            </p>
          </div>
        </div>
        ...
        <div class="shadow-xl lg:w-1/6	p-4 m-3 py-6 rounded-md">
          ...
          <div>
            ...
            <p class="text-sm pb-5">
              Withdrawals are processed instanly, day to day to avoid backlogs.
            </p>
          </div>
        </div>
      ...
      <div class="lg:flex justify-center text-center">
        ...
        >
          ...
          <input
            type="button"
            value="JOIN NOW"
            class="p-2 pl-5 pr-5 my-4 text-sm bg-l-blue text-white rounded-md"
          />
        </div>
    ...
    <div>
      ...
      <div class="flex justify-center">
        <div class="bg-blue-300 border-4 m-4 border-blue rounded-xl p-3">
        ...
        <div class="lg:flex justify-center">
          <div class="lg:w-60 w-full mx-auto p-8 rounded-md ">
            <div class="flex">
              ...
              <h1
                class="p-4 border-4 w-20 relative -ml-10 mb-12 right-24 border-blue rounded-full text-white text-3xl font-extrabold bg-blue-300"
              >
                01.
              </h1>
            </div>
          ...
          <div class="lg:w-60 w-full mx-auto p-8 rounded-md ">
            <div class="flex">
              ...
              <h1
                class="p-4 border-4 w-20 relative -ml-14 mb-12 right-24 border-blue rounded-full text-white text-3xl font-extrabold bg-blue-300"
              >
                02.
              </h1>
            </div>
        ...
        <div class="text-center lg:m-20 mb-6">
          ...
          <div class="lg:flex justify-center mt-28">
            ...
            >
              ...
              <p class="tl-blue p-3 text-xs">Alessia S.</p>
            </div>
