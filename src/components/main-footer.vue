      ...
      <div class="lg:flex">
        ...
        <div class="text-sm lg:w-5/12 m-4">
          ...
          <div class="pt-6">
            ...
            <p class="text-white py-2">Investment Plans</p>
            <p class="text-white py-2">Payment Mehods</p>
            <p class="text-white py-2">Investment Process</p>
            <p class="text-white py-2">Reviews</p>
          </div>
        </div>
        ...
        <div class="text-sm lg:w-5/12 m-4">
          ...
          <div class="pt-6">
            <p class="text-white py-2">
              Dunlewey House, 128, Greenfield Rd, Birmingham, B17 0EG, U.K.
            </p>
            <p class="text-white py-2">+44 (0) 121 643 9460</p>
            <p class="text-white py-2">trade@crypthlogfx.com</p>
          </div>
        </div>
